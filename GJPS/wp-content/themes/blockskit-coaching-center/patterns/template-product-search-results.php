 ...
 * Slug: blockskit-coaching-center/template-product-search-results
 * Categories: template
 * Inserter: false
 */
...
<!-- wp:query-no-results -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( 'No products were found matching your selection.', 'blockskit-coaching-center' ); ?></p>
<!-- /wp:paragraph -->
