...
if ( ! class_exists( 'Ecommerce_Landing_Page_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Ecommerce_Landing_Page_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'ecommerce_landing_page_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function ecommerce_landing_page_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Ecommerce_Landing_Page_WPTT_WebFont_Loader( $url );
...
if ( ! function_exists( 'ecommerce_landing_page_wptt_get_webfont_url' ) ) {
	 ...
	 * @return string Returns the CSS.
	 */
	function ecommerce_landing_page_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Ecommerce_Landing_Page_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
