<?php
	...
	if($ecommerce_landing_page_first_color != false){
		$ecommerce_landing_page_custom_css .='.home-page-header,.main-navigation ul ul,.slider-nav-image-sec,.wp-block-woocommerce-empty-cart-block .wc-block-grid__product-onsale,#footer .tagcloud a:hover{';
	...
	$ecommerce_landing_page_resp_slider = get_theme_mod( 'ecommerce_landing_page_resp_slider_hide_show',true);
	if($ecommerce_landing_page_resp_slider == true && get_theme_mod( 'ecommerce_landing_page_show_hide_banner', true) == false){
	...
	if($ecommerce_landing_page_copyright_alingment != false){
		$ecommerce_landing_page_custom_css .='.copyright p{';
			$ecommerce_landing_page_custom_css .='text-align: '.esc_attr($ecommerce_landing_page_copyright_alingment).';';
		$ecommerce_landing_page_custom_css .='}';
		$ecommerce_landing_page_custom_css .='
	...
	$ecommerce_landing_page_align_footer_social_icon = get_theme_mod('ecommerce_landing_page_align_footer_social_icon');
	if($ecommerce_landing_page_align_footer_social_icon != false){
		$ecommerce_landing_page_custom_css .='.copyright .widget{';
			$ecommerce_landing_page_custom_css .='text-align: '.esc_attr($ecommerce_landing_page_align_footer_social_icon).';';
		$ecommerce_landing_page_custom_css .='}';
		$ecommerce_landing_page_custom_css .='
		@media screen and (max-width:720px) {
			.copyright .widget{';
	...
	$ecommerce_landing_page_resp_stickycopyright = get_theme_mod( 'ecommerce_landing_page_stickycopyright_hide_show',false);
	if($ecommerce_landing_page_resp_stickycopyright == true && get_theme_mod( 'ecommerce_landing_page_copyright_sticky',false) != true){
    	$ecommerce_landing_page_custom_css .='.copyright-sticky{';
			$ecommerce_landing_page_custom_css .='position:static;';
		$ecommerce_landing_page_custom_css .='} ';
	}

	$ecommerce_landing_page_footer_social_icons_font_size = get_theme_mod('ecommerce_landing_page_footer_social_icons_font_size','16');
	$ecommerce_landing_page_custom_css .='.copyright .widget i{';
		$ecommerce_landing_page_custom_css .='font-size: '.esc_attr($ecommerce_landing_page_footer_social_icons_font_size).'px;';
	$ecommerce_landing_page_custom_css .='}';
    ...
    if($ecommerce_landing_page_theme_lay == 'Default'){
		...
		$ecommerce_landing_page_custom_css .='.post-main-box, .post-main-box h2, .post-main-box .post-info, .new-text p, .content-bttn{';
			$ecommerce_landing_page_custom_css .='text-align:center;';
		$ecommerce_landing_page_custom_css .='}';
		...
		$ecommerce_landing_page_custom_css .='.post-main-box, .post-main-box h2, .post-main-box .post-info, .new-text p, .content-bttn, #our-services p{';
			$ecommerce_landing_page_custom_css .='text-align:Left;';
		$ecommerce_landing_page_custom_css .='}';
		$ecommerce_landing_page_custom_css .='.post-info hr{';
	...
	$ecommerce_landing_page_related_image_box_shadow = get_theme_mod('ecommerce_landing_page_related_image_box_shadow',0);
	if($ecommerce_landing_page_related_image_box_shadow != false){
		$ecommerce_landing_page_custom_css .='.related-post .box-image img{';
			$ecommerce_landing_page_custom_css .='box-shadow: '.esc_attr($ecommerce_landing_page_related_image_box_shadow).'px '.esc_attr($ecommerce_landing_page_related_image_box_shadow).'px '.esc_attr($ecommerce_landing_page_related_image_box_shadow).'px #cccccc;';
		$ecommerce_landing_page_custom_css .='}';
	}
	...
	$ecommerce_landing_page_button_letter_spacing = get_theme_mod('ecommerce_landing_page_button_letter_spacing');
	...
	//Button hover effect
	$ecommerce_landing_page_button_hover_effect = get_theme_mod('ecommerce_landing_page_button_hover_effect', 'disable');
	if ($ecommerce_landing_page_button_hover_effect !== 'disable') {
		$ecommerce_landing_page_custom_css .= '.more-btn a:hover {';
		switch ($ecommerce_landing_page_button_hover_effect) {
			case 'pulse':
				$ecommerce_landing_page_custom_css .= 'animation: pulse 0.5s ease-in-out !important;';
				break;
			case 'rubberBand':
				$ecommerce_landing_page_custom_css .= 'animation: rubberBand 0.5s ease-in-out !important;';
				break;
			case 'swing':
				$ecommerce_landing_page_custom_css .= 'animation: swing 0.5s ease-in-out !important;';
				break;
			case 'tada':
				$ecommerce_landing_page_custom_css .= 'animation: tada 0.5s ease-in-out !important;';
				break;
			case 'jello':
				$ecommerce_landing_page_custom_css .= 'animation: jello 0.5s ease-in-out!important;';
				break;
		}
		$ecommerce_landing_page_custom_css .= '}';
	}
	...
	// button font weight
	$ecommerce_landing_page_button_font_weight = get_theme_mod('ecommerce_landing_page_button_font_weight');
  	$ecommerce_landing_page_custom_css .='.post-main-box .more-btn a{';
    $ecommerce_landing_page_custom_css .='font-weight: '.esc_attr($ecommerce_landing_page_button_font_weight).'!important;';
  	$ecommerce_landing_page_custom_css .='}';
	...
	$ecommerce_landing_page_grid_featured_image_border_radius = get_theme_mod('ecommerce_landing_page_grid_featured_image_border_radius', 0);
	if($ecommerce_landing_page_grid_featured_image_border_radius != false){
		$ecommerce_landing_page_custom_css .='.grid-post-main-box .box-image img, .grid-post-main-box .feature-box img{';
			$ecommerce_landing_page_custom_css .='border-radius: '.esc_attr($ecommerce_landing_page_grid_featured_image_border_radius).'px;';
		$ecommerce_landing_page_custom_css .='}';
	}
	...
	if($ecommerce_landing_page_resp_menu_toggle_btn_bg_color != false){
		$ecommerce_landing_page_custom_css .='.toggle-nav i,.closebtn i{';
	...
	// sticky sidebar
		$ecommerce_landing_page_resp_stickysidebar = get_theme_mod( 'ecommerce_landing_page_stickysidebar_hide_show',false);
	if($ecommerce_landing_page_resp_stickysidebar == true && get_theme_mod( 'ecommerce_landing_page_sticky_sidebar',false) != true){
		$ecommerce_landing_page_custom_css .= '@media (min-width: 768px) {';
    	$ecommerce_landing_page_custom_css .='#sidebar{';
			$ecommerce_landing_page_custom_css .='position:static;';
		$ecommerce_landing_page_custom_css .='} ';
		$ecommerce_landing_page_custom_css .= '}';
	...
	$ecommerce_landing_page_show_first_caps = get_theme_mod('ecommerce_landing_page_show_first_caps', false);
	if ($ecommerce_landing_page_show_first_caps ) {
	    $ecommerce_landing_page_custom_css .= '.post-main-box .new-text p:nth-of-type(1)::first-letter {';
	    $ecommerce_landing_page_custom_css .=' font-size: 55px;font-weight: 600;margin-right: 5px;';
	    $ecommerce_landing_page_custom_css .='}';
	} else {
		$ecommerce_landing_page_custom_css .= '.post-main-box .new-text p:nth-of-type(1)::first-letter {';
	    $ecommerce_landing_page_custom_css .= 'display: none;';
	...
	// Web Frame 
	$ecommerce_landing_page_web_frame = get_theme_mod('ecommerce_landing_page_web_frame',false);
	if($ecommerce_landing_page_web_frame == false && get_theme_mod( 'ecommerce_landing_page_web_frame',false) != true){
		$ecommerce_landing_page_custom_css .='.web-frame{';
		$ecommerce_landing_page_custom_css .='border: 1px !important';
		$ecommerce_landing_page_custom_css .='}';
	}

	$ecommerce_landing_page_web_frame_border_color = get_theme_mod('ecommerce_landing_page_web_frame_border_color');
	if($ecommerce_landing_page_web_frame_border_color != false){
		$ecommerce_landing_page_custom_css .='.web-frame{';
			$ecommerce_landing_page_custom_css .='border-color: '.esc_attr($ecommerce_landing_page_web_frame_border_color).'!important;';
		$ecommerce_landing_page_custom_css .='}';
	}
    
	$ecommerce_landing_page_web_frame_border_width = get_theme_mod('ecommerce_landing_page_web_frame_border_width');
	if($ecommerce_landing_page_web_frame_border_width != false){
		$ecommerce_landing_page_custom_css .='.web-frame{';
			$ecommerce_landing_page_custom_css .='border-width: '.esc_attr($ecommerce_landing_page_web_frame_border_width).'!important;';
		$ecommerce_landing_page_custom_css .='}';
	}

	// change the Category style //
	$ecommerce_landing_page_single_post_styling = get_theme_mod( 'ecommerce_landing_page_single_post_styling','Button');
		if($ecommerce_landing_page_single_post_styling == 'Underline'){
		$ecommerce_landing_page_custom_css .='.single-post-category .post-categories li a{';
			$ecommerce_landing_page_custom_css .='text-decoration: underline; color: #000; background-color: transparent !important;';
		$ecommerce_landing_page_custom_css .='}';
	}
	else if($ecommerce_landing_page_single_post_styling == 'Default'){
		$ecommerce_landing_page_custom_css .='.single-post-category .post-categories li a{';
			$ecommerce_landing_page_custom_css .='text-decoration: none; color: #000; background-color: transparent !important;';
		$ecommerce_landing_page_custom_css .='}';
	}
	// Hover on featured image //
	$ecommerce_landing_page_show_featured = get_theme_mod( 'ecommerce_landing_page_featured_image_hide_show', 1 );
	$ecommerce_landing_page_hover_effect  = get_theme_mod( 'ecommerce_landing_page_featured_image_hover', 'none' );

	if ( $ecommerce_landing_page_show_featured && $ecommerce_landing_page_hover_effect !== 'none' ) {
		...
		if ( $ecommerce_landing_page_hover_effect === 'zoom-in' ) {
			$ecommerce_landing_page_custom_css .= '
		...
		if ( $ecommerce_landing_page_hover_effect === 'zoom-out' ) {
			$ecommerce_landing_page_custom_css .= '
			.ecommerce-landing-page-featured-image img{
				transform: scale(1.2);
			}
		...
		if ( $ecommerce_landing_page_hover_effect === 'grayscale' ) {
			$ecommerce_landing_page_custom_css .= '
			.ecommerce-landing-page-featured-image img{
		...
		if ( $ecommerce_landing_page_hover_effect === 'sepia' ) {
			$ecommerce_landing_page_custom_css .= '
			.ecommerce-landing-page-featured-image:hover img{
				filter: sepia(100%);
			}';
		...
		if ( $ecommerce_landing_page_hover_effect === 'blur' ) {
			$ecommerce_landing_page_custom_css .= '
			.ecommerce-landing-page-featured-image:hover img{
				filter: blur(3px);
			}';
		...
		if ( $ecommerce_landing_page_hover_effect === 'bright' ) {
			$ecommerce_landing_page_custom_css .= '
			.ecommerce-landing-page-featured-image:hover img{
		...
		if ( $ecommerce_landing_page_hover_effect === 'translate' ) {
			$ecommerce_landing_page_custom_css .= '
			.ecommerce-landing-page-featured-image:hover img{
