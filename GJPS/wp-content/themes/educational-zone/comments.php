...
<div id="comments" class="comments-area card-body">
    ...
    <?php
        comment_form( array(
            ...
            'title_reply' => esc_html(get_theme_mod('educational_zone_single_post_comment_title',__('Leave a Reply','educational-zone' )) ),
            'label_submit' => esc_html(get_theme_mod('educational_zone_single_post_comment_btn_text',__('Post Comment','educational-zone' )) ),
        ) );
    ?>
</div>
