...
function education_zone_admin_notice(){
	...
	$dismissnonce    = wp_create_nonce( 'education_zone_admin_notice' );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><a href="<?php echo esc_url( admin_url( 'themes.php?page=education-zone-dashboard' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Go to the dashboard.', 'education-zone' ); ?></a></p>
                    <p class="dismiss-link"><strong><a href="?education_zone_admin_notice=1&_wpnonce=<?php echo esc_attr( $dismissnonce ); ?>"><?php esc_html_e( 'Dismiss', 'education-zone' ); ?></a></strong></p>
                </div>
            </div>
        </div>
    <?php }
...
function education_zone_update_admin_notice(){
	...
	if (!current_user_can('manage_options')) {
     ...
     if ( ( isset( $_GET['education_zone_admin_notice'] ) && $_GET['education_zone_admin_notice'] = '1' ) && wp_verify_nonce( $_GET['_wpnonce'], 'education_zone_admin_notice' ) ) {
