...
function education_zone_body_classes( $classes ) {
    ...
    || ( $my_theme['Name'] == 'Education Spark' && $theme_style_es =='modern' )) {
...
function education_zone_social_cb(){
    ...
    $tiktok    = get_theme_mod( 'education_zone_tiktok' );
	...
	<ul class="social-networks">
        ...
        <?php } if( $tiktok ){ ?>
        <li><a href="<?php echo esc_url( $tiktok ); ?>" target="_blank" title="<?php esc_attr_e( 'Tiktok', 'education-zone' );?>"><i class="fab fa-tiktok"></i></a></li>
        <?php } ?>
	</ul>
    <?php
    }    
