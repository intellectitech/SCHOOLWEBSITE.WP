<?php
 /**
  * Title: Template 404
  * Slug: blockskit-coaching-center/template-404
  * Categories: template
  * Inserter: false
  */
...
<!-- wp:cover {"url":"<?php echo esc_url($blockskit_coaching_center_images[0]); ?>","id":79,"dimRatio":80,"overlayColor":"foreground","focalPoint":{"x":0.5,"y":0},"minHeight":700,"style":{"spacing":{"padding":{"top":"var:preset|spacing|large","bottom":"var:preset|spacing|large"}}}} -->
...
<p class="has-text-align-center"><?php esc_html_e( 'This page could not be found. Maybe try a search?', 'blockskit-coaching-center' ); ?></p>
<!-- /wp:paragraph -->
