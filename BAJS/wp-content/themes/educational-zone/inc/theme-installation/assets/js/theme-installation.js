...
jQuery(document).ready(function($) {
    ...
    function copyCouponCode() {
        const copyBtn = document.querySelector(".custom-coupon-copy-btn");
        const copyInput = document.querySelector(".custom-coupon-banner-code");

        const text = copyInput.value || copyInput.innerText;
    ...
    document.querySelector(".custom-coupon-copy-btn").addEventListener("click", copyCouponCode);
});